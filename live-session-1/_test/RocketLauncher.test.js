...
describe('A RocketLauncher', () => {
    it('should return correct RocketLauncher instance', () => {
        const nasaRocket = new Rocket('Nasa');
        const spaceXRocket = new Rocket('SpaceX');
        
        const expectedValue = {
            repairKit: {},
            rockets: [nasaRocket, spaceXRocket],
        };
        
        const rocketLauncher = new RocketLauncher({}, [nasaRocket, spaceXRocket]);
        expect(rocketLauncher).toBeInstanceOf(RocketLauncher);
        expect(rocketLauncher).toEqual(expectedValue);
    });
    ...
    it('should launch all rockets', () => {
        ...
        const nasaRocket = new Rocket('Nasa');
        const spaceXRocket = new Rocket('SpaceX');
        const rocketLauncher = new RocketLauncher(null, [nasaRocket, spaceXRocket]);
...
describe('A RocketLauncher', () => {
    // dummy example
    it('should launch all rocket dummy', () => {
        // Arrange
        const nasaRocket = new Rocket('Nasa');
        const spaceXRocket = new Rocket('SpaceX');
        // dummy
    ...
    it('should launch only one rocket by queue dummy', () => {
        // Arrange
        const nasaRocket = new Rocket('Nasa');
        const spaceXRocket = new Rocket('SpaceX');
        // dummy
